      ...
      <div className='rounded-[1.25rem] max-w-[88rem] xsm:max-w-full overflow-hidden '>
        <div className='grid sm:grid-cols-2 items-start bg-[#38b6ff]'>
          ...
          <div className='px-[2.0625rem] py-[2.25rem] xsm:p-[1rem]'>
            <h2 className='fade-item font-montserrat font-bold text-[2.5rem] leading-[1.3] tracking-[-0.075rem] xsm:text-[1.25rem] xsm:leading-[1.2] xsm:tracking-[-0.05rem] text-white mb-[1.25rem] xsm:mb-[1rem]'>
              {data?.title}
            </h2>
