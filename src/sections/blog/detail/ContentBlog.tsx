    ...
    <section className='w-[60rem] xsm:w-full xsm:p-[1rem]'>
      ...
      <div className='mt-[5rem] xsm:mt-[1.5rem]'>
        <div
          ...
          className='[&_div]:!w-full *:font-montserrat [&_em]:content-em [&_h2]:content-h2 [&_h3]:content-h3 [&_img]:content-img [&>p]:content-p [&>span]:content-span [&_strong]:content-strong [&_ol_li]:content-ol--li [&_ul_li]:content-ul--li [&>ul]:content-ul [&>ol]:content-ol'
        ></div>
