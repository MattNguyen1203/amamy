    ...
    <section className='w-[60rem] xsm:w-full xsm:p-[1rem]'>
            ...
            {headings?.map((item: Iheadings, index: number) => (
              <div key={index}>
                <Link
                  ...
                  className={cn(
                    'text-[0.75rem] font-semibold leading-[1.4] tracking-[-0.015rem] text-[rgba(0,0,0,0.80)] [&.active]:text-[#09A5FF] hover:text-[#09A5FF] transition-all duration-500',
                  )}
                >
                  {item?.text}
                </Link>
      ...
      <div className='mt-[5rem] xsm:mt-[1.5rem]'>
        <div
          ...
          className='content-detail-blog [&_div]:!w-full *:font-montserrat [&_em]:content-em [&_h2]:content-h2 [&_h3]:content-h3 [&>img]:content-img [&>figure>img]:content-img [&>p]:content-p [&>span]:content-span [&_strong]:content-strong [&_ol_li]:content-ol--li [&_ul_li]:content-ul--li [&>ul]:content-ul [&>ol]:content-ol [&_p_img]:inline-block [&_p_img]:m-0'
        ></div>
