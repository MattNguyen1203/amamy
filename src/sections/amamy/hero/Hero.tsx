  ...
  return (
    <section className='size-full bg-Blue-Primary px-[6rem] py-10 xsm:px-[1rem] xsm:py-8'>
      <div className='mx-auto flex flex-col items-center pt-14 text-center text-white xsm:pt-0'>
        {/* Heading */}
        <h1 className='mb-4 text-center text-[4rem] font-bold leading-[122%] xsm:text-[1.5rem]'>
          Bạn có ý định gửi hàng ?
        </h1>
        <p className='mb-14 max-w-[41.875rem] text-center text-base leading-[100%] xsm:mb-5 xsm:mb-7 xsm:max-w-[17.938rem] xsm:text-sm'>
        ...
        {/* CTA */}
        <button className='w-full max-w-sm rounded-[1.5rem] bg-white px-[1.813rem] py-4 text-center text-[1.2rem] font-medium leading-[1.56rem] tracking-[-0.036rem] text-Blue-Primary xsm:max-w-64 xsm:px-3 xsm:py-[0.375rem] xsm:text-sm'>
