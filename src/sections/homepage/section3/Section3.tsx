...
const Section3 = ({sectionCountry, section3}: Props) => {
  return (
    <div>
      <div className='w-full flex xsm:flex-col xsm:mt-[2rem]'>
        ...
        <div className='hidden xsm:block'>
            <div className='flex flex-col items-start gap-[.5rem] relative mx-[1rem]'>
              <p className='text-[1.375rem] not-italic font-bold leading-[120%]'>
                {section3.title}
              </p>
        ...
        <div className=' flex-1 flex gap-[1rem] pt-[9.62rem] bg-[#C1E8FF] pl-[4.5rem] relative xsm:bg-transparent xsm:pt-[1rem] xsm:pl-[1rem] xsm:w-screen xsm:overflow-x-scroll'>
          <Image
            src={'/homepage/icon/Isolation_Mode.png'}
            alt='background-image'
            className='absolute inset-0 left-[20] z-[-1] bottom-0 w-[89.4375rem] h-[35.50475rem] flex-shrink-0 xsm:w-screen '
            width={1000}
            height={1000}
          />
          ...
          <div
           ...
           bg-[var(--BACKGROUND-ELEVATION-5,_#FFF)] [box-shadow:0px_4px_23.7px_0px_rgba(0,_0,_0,_0.00)] group xsm:w-[17.5rem]'
          >
            ...
            <div className='mx-6 group-hover:hidden h-full flex flex-col pb-6'>
              <h2 className='text-[2.875rem] not-italic font-bold leading-[120%] mb-[0.5rem] mt-[1.75rem]'>
          ...
          <div
            className='cursor-pointer rounded-[0.5rem] w-80 flex flex-col h-[23.0625rem] rounded-br-[var(--8,] rounded-tr-[0.5rem)] rounded-bl-[0.5rem)] 
           bg-[var(--BACKGROUND-ELEVATION-5,_#FFF)] [box-shadow:0px_4px_23.7px_0px_rgba(0,_0,_0,_0.00)] group '
          >
            <div className='w-[3.72rem] static z-10 h-[2.36rem] mx-6 mt-6 '>
              <Image
