...
const Section6 = (props: Props) => {
  return (
    <div className='flex pt-24 pl-24 pb-24 flex-col items-start gap-2.5 self-stretch w-full xsm:pl-[1rem]'>
     <div className='flex justify-between w-full flex-col'>
       <div className='flex  justify-between w-full mb-[2.5rem] xsm:items-center'>
        <h2 className='text-[2.875rem] not-italic font-bold leading-[120%] xsm:text-[1.375rem]'>Các tin tức mới nhất</h2>
            <button className='flex rounded-[0.5rem] mr-24 xsm:mr-[1rem] xsm:rounded-full xsm:w-[2.66rem] xsm:flex-shrink-0 xsm:h-[2.66rem] xsm:p-0 text-white h-12 pl-6 pr-4 py-3 
