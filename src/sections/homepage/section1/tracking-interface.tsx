  ...
  return (
    <div className='w-full max-w-3xl mx-auto p-4 xsm:p-0 xsm:max-w-[calc(100vw-2rem)] xsm:w-[calc(100vw-2rem)] xsm:rounded-[1.25rem] xsm:mx-0'>
      <Tabs
        ...
        className='w-full xsm:max-w-[calc(100vw-2rem)]'
      >
        <TabsList
          className={`h-14 p-0 bg-transparent justify-start bg-[#D9D9D9] w-fit xsm:w-full xsm:h-[2.5rem] xsm:max-w-[calc(100vw-2rem)] xsm:rounded-t-[1.25rem]`}
        >
          <TabsTrigger
            value='track'
      ...
      {activeTab == 'track' && (
        <div className='bg-white rounded-b-3xl p-6 space-y-4 xsm:p-[1rem]'>
          <Input
            placeholder='Nhập mã vận đơn'
            className='h-14 text-lg rounded-xl border-[#d9d9d9] xsm:rounded-full xsm:h-[2.5rem]
        xsm:text-[0.8125rem] xsm:not-italic xsm:font-medium xsm:leading-4'
          />
          <Button
            className='w-full h-14 text-lg font-medium bg-[#38b6ff] hover:bg-[#38b6ff]/90 rounded-xl
      ...
      {activeTab == 'estimate' && (
        <div className='bg-white rounded-b-3xl p-6 space-y-4'>
          <h1 className='text-[0.75rem] not-italic font-semibold leading-[normal] tracking-[-0.015rem] uppercase text-black '>
          ...
          <div className=''>
            <div
              className='flex items-center  p-[1px] rounded-xl bg-gradient-to-r from-[#c1e8ff] relative to-white  '
              style={{
            ...
            <p className='text-[#29343e]/70 text-sm mt-2 px-4'>
              Hãy nhập thông tin vận chuyển vào box chat để nhận báo giá từ trợ
              lý AI.
            </p>
          </div>
        </div>
...
const SendIcon = () => (
  ...
  >
    <path
      fillRule='evenodd'
      clipRule='evenodd'
      d='M21.4015 2.15198L2.5455 7.75798L2.1875 7.89398V8.53398L9.5675 13.466L15.2175 7.81598L16.2785 8.87698L10.6165 14.538L15.3535 21.626L15.5265 21.848H16.1685L21.7625 2.89398L21.8125 2.58198L21.4015 2.15198Z'
      fill='white'
    />
  </svg>
)
