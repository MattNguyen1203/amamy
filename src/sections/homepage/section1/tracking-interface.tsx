  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className={`h-14 p-0 bg-transparent justify-start bg-[#D9D9D9] w-fit`}>
          <TabsTrigger
            value="track"
          ...
          <TabsTrigger
            value="estimate"
            className="w-[14.375rem] h-full rounded-none rounded-t-[0.5rem] data-[state=inactive]:rounded-bl-[0.5rem] !shadow-none data-[state=active]:bg-white data-[state=active]:text-[#2a3441] data-[state=inactive]:bg-[#d9d9d9] data-[state=inactive]:text-[#2a3441]/60 text-lg font-medium"
          >
      ...
      {activeTab == 'track' && <div className="bg-white rounded-b-3xl p-6 space-y-4">
        <Input placeholder="Nhập mã vận đơn" className="h-14 text-lg rounded-xl border-[#d9d9d9]" />
