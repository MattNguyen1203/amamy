  ...
  return (
    ...
    >
      <div className='flex items-start justify-between mt-[0.75rem] xsm:mt-[0.45rem]'>
        {/* Content Container */}
        <div className='flex flex-col gap-y-[0.81rem] text-white mt-[1.12rem] flex-1 xsm:mt-[0.67rem] xsm:gap-y-0'>
          <p className='min-w-[13rem] text-[1.5rem] font-bold leading-[150%] tracking-[-0.045rem] mr-[1.75rem] xsm:text-[0.8955rem] xsm:min-w-0 xsm:mr-[1.13rem]'>
            {label}
          </p>
          <p className='max-w-[13rem] text-[0.875rem] font-medium leading-[1.3125rem] tracking-[-0.02625rem] xsm:text-[0.52238rem] xsm:leading-[0.78356rem] xsm:tracking-[-0.01569rem] xsm:mt-[0.58rem]'>
            {desc}
          </p>
        </div>
        {/* Image Container */}
      ...
      <Link
        href={link || '#'}
        className='mt-auto mb-[1.37rem] flex h-[3.125rem] items-center justify-between rounded-[1.25rem] bg-white px-[0.94rem] py-[0.54rem] xsm:mb-[0.82rem] xsm:h-[1.86569rem] xsm:p-[0_0.45rem_0_0.56rem]'
      >
