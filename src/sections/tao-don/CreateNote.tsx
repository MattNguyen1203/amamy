        ...
        >
          {data?.Item_that_can_be_sent && data?.unable_to_send && (
            <div className='p-[1rem] rounded-[1.25rem] bg-white space-y-[1rem]'>
              {data?.Item_that_can_be_sent && (
                <div>
                  <p className='mb-[0.3rem] text-black font-montserrat text-[1rem] font-semibold leading-[1.625] tracking-[-0.03rem]'>
                    {type === 'viethan'
                      ? 'Mặt hàng có thể gửi nhưng rủi ro (cần đọc kỹ):'
                      : 'Mặt hàng có thể gửi:'}
                  </p>
                  <div
                    className='[&_h3]:text-pc-tab-title [&_h3]:text-black [&_strong]:text-pc-sub14s [&_strong]:text-black *:text-[rgba(0,0,0,0.90)] *:text-pc-sub14r [&_ul]:content-ul [&_ul]:!my-0 marker:[&_ul_li]:text-[rgba(0,0,0,0.80)] [&_ol]:content-ol [&_ol>li]:my-[0.5rem] [&_ol]:!my-0'
              ...
              {data?.unable_to_send && (
                <div>
                  ...
                  <div
                    className='[&_h3]:text-pc-tab-title [&_h3]:text-black [&_strong]:text-pc-sub14s [&_strong]:text-black *:text-[rgba(0,0,0,0.90)] *:text-pc-sub14r [&_ul]:content-ul [&_ul]:!my-0 marker:[&_ul_li]:text-[#F00] [&_ol]:content-ol [&_ol>li]:my-[0.5rem] [&_ol]:!my-0'
                    dangerouslySetInnerHTML={{
                ...
                render={({field}) => (
                  <FormItem className='relative flex flex-row items-center space-y-0 space-x-[0.5rem] border-none'>
                    ...
                    <div className='space-y-1 leading-none'>
                      <FormLabel className='cursor-pointer text-pc-sub14m text-black'>
                  ...
                  <FormField
                    ...
                    render={({field}) => (
                      <FormItem className='relative flex flex-row items-center space-y-0 space-x-[0.5rem] border-none'>
                        ...
                        <div className='space-y-1 leading-none'>
                          <FormLabel className='text-pc-sub14m text-black'>
                            {item?.agree_with ||
          ...
          {data?.cargo_insurance && (
            <div className='p-[1rem] rounded-[1.25rem] bg-white space-y-[1rem]'>
              ...
              <div
                className='[&_h3]:text-pc-tab-title [&_h3]:text-black [&_strong]:text-pc-sub14s [&_strong]:text-black *:text-[rgba(0,0,0,0.90)] *:text-pc-sub14r [&_ul]:content-ul [&_ol]:content-ol [&_ol>li]:my-[0.5rem] [&_ol]:!my-0 [&_ul]:!my-0 marker:[&_ul_li]:text-[rgba(0,0,0,0.80)]'
                dangerouslySetInnerHTML={{
