...
const ShippingHero: React.FC<Prop> = ({data}) => {
  return (
    <section className='w-full bg-[#38b6ff] pb-20 xsm:py-8 text-white'>
      <div className='w-full mx-auto px-[6rem] xsm:px-[1rem]'>
        ...
        <div className='text-center'>
          <h1 className='text-[2.625rem] xsm:text-[1.125rem] font-bold leading-tight'>
            {data?.banner?.title || ''}
          </h1>
          <p className='mt-4 mx-auto max-w-[41.25rem] text-[1rem] xsm:text-[0.875rem] leading-relaxed'>
