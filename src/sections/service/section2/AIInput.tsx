...
const AIInput = ({
  ...
  return (
    <div className={cn('relative', className)}>
      <div className='w-[calc(100%+1.6rem)] h-[calc(100%+0.5rem)] -top-1 -left-[0.8rem] absolute rounded-[1.875rem] bg-[linear-gradient(90deg,#F26AFF_0%,#9E65FF_21.28%,#436EFF_100%)] blur-[9.8px] mix-blend-hard-light' />
