...
export const MainContainer = ({title, phone, listService}: Prop) => {
  ...
  return (
    <div className='fade-section flex pr-auto items-start relative rounded-[var(--token-8)] overflow-hidden xsm:block xsm:bg-white'>
      <div className='flex flex-col items-start relative  pl-[6rem] w-[26.875rem] xsm:w-full xsm:px-[1rem]'>
        <div className='fade-item relative self-stretch w-full h-[26.9375rem] xsm:h-auto xsm:w-full rounded-[1.25rem_0px_0px_1.25rem]  xsm:rounded-[1.25rem] overflow-hidden'>
          <div className='relative w-[20.875rem] h-[26.9375rem] xsm:h-[11.25rem] xsm:w-full '>
            ...
            <Link
              href={`tel:${phone}`}
              className='xsm:text-1rem xsm:font-semibold xsm:leading-[1.3] xsm:tracking-[-0.04rem] absolute left-7 xsm:left-[4.313rem] bottom-[1.75rem] flex mt-[0.75rem] h-12 justify-center text-[#38B6FF] xsm:text-[1rem] w-[15.875rem] xsm:w-[12.813rem] items-center gap-2 rounded-[1.25rem]  
