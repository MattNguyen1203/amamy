                  ...
                  <Card className={`h-[20.5625rem] w-[20.875rem] border-none ${index % 2 === 0 ? 'bg-[#DBF5FF]' : 'bg-[#F2F2F2]'}`}>
                    <CardContent className='p-[1.5rem]'>
                      ...
                      <div className='flex items-center gap-3'>
                        ...
                        />
                        <div>
                          <h4 className='font-montserrat font-semibold text-[1.125rem] leading-[1.4625rem] tracking-normal'>{testimonial.name}</h4>
