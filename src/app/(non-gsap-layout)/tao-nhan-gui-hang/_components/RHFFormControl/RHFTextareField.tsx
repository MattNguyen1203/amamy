          ...
          <FormControl>
            <div className='relative'>
              ...
              <Textarea
                ...
                className={cn(
                  'h-[3rem] min-h-[unset] resize-none rounded-[1.25rem] border border-solid border-[#DCDFE4] bg-white px-[1rem] py-[0.75rem] text-[0.875rem] font-medium leading-[150%] tracking-[-0.02625rem] text-[rgba(0,0,0,0.92)] placeholder:text-black/30 xsm:h-[2.5rem] xsm:px-[0.75rem] xsm:text-[0.8125rem] xsm:leading-[1rem] xsm:tracking-[-0.02438rem]',
