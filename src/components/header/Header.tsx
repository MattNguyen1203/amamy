  ...
  return (
    <>
      ...
      <div className='flex items-center min-w-[16.425rem] gap-[1rem] h-full'>
        ...
        {!isScrolled ?
          <ImageV2 alt='Search' src={'/homepage/icon/searchIcon.svg'} width={1000} height={1000} className='w-[1.28175rem] my-auto h-[1.28175rem] gap-2' />
        :
