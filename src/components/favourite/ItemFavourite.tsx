...
export default function ItemFavourite({item}: {item: IFavouriteBlog}) {
  return (
    <Link
      ...
      className='group xsm:block w-full sm:p-[1rem] xsm:py-[1rem] space-y-[0.75rem]'
    >
      <p className='line-clamp-2 text-[#000] text-pc-sub16s xsm:text-[0.875rem] xsm:font-semibold xsm:leading-[1.4] xsm:tracking-[-0.035rem] transition-all duration-500 group-hover:underline'>
        {item?.title}
      </p>
